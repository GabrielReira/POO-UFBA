...
public class Aplicacao
{
  ...
  public static void valorReferenciaAluguel(Scanner sc, Imovel imovel) {
    ...
    // Se o imóvel for uma unidade compartilhada sem itens de lazer, reduzir 10% no valor de referência
    ...
    System.out.println(valorReferencia + valorReferencia * indiceSazonalidade);
    System.out.println();
  }
}
